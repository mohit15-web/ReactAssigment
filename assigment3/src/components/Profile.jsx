  ...
  return (
    ...
    <h1 className="font-extrabold text-center text-xl mt-1 ml-4">Profile</h1>
      ...
      <div className=" border-r-4 border-black border-b-4 px-6 mt-5 py-6">
        <h1 className="font-extrabold text-3xl">Mohit <br />Chaudhary</h1>
        <p className=" tracking-wider">Frontend Developer</p>
      </div>
      <div className="border-b-4 border-black px-6 mt-10">
        <p>hi i am mohit Chaudhary front end developer Lorem, ipsum dolor sit amet consectetur adipisicing elit. Corporis, pariatur.</p>
        <h1>
          <strong>Email</strong>:mohitchoudharu2@gmail.com
        </h1>
        <h1>
